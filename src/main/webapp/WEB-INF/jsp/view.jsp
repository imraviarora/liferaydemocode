<%@ include file="/WEB-INF/jsp/init.jsp" %>
 <portlet:actionURL var="regURL" name="registration">
		...
		<section id="wrap-form">
			<form action="<%=regURL%>" method="POST">
				<div class="wrap-input icon-briefcase">
					<input type="text" name="<portlet:namespace/>prefix" placeholder="Prefix">
				</div>
				<div class="wrap-input icon-user">
					<input type="text" name="<portlet:namespace/>fname" placeholder="First Name">
					<a href="#" title="More Info"><i class="fas fa-info-circle"></i></a>
				</div>
				<div class="wrap-input icon-user">
					<input type="text" name="<portlet:namespace/>lname" placeholder="Last Name">
					<a href="#" title="More Info"><i class="fas fa-info-circle"></i></a>
				</div>
				<div class="wrap-input icon-envelope">
					<input type="text" name="<portlet:namespace/>email" placeholder="Institution Email">
				</div>
				<div class="wrap-input icon-shield">
					<input type="text" name="<portlet:namespace/>institute-name" placeholder="Institution Name">
				</div>
				<div class="wrap-input icon-lock">
					<input id="password-field" type="password" name="<portlet:namespace/>password1" placeholder="Password" value="secret">
					<span class="icon-eye fa fa-fw fa-eye field-icon toggle-password"></span>
				</div>
				<div class="wrap-input icon-lock">
					<input id="password-field-confirm" type="password" name="<portlet:namespace/>password2" placeholder="Confirm Password" value="secret">
					<a href="#" title="more info"><i class="fas fa-info-circle"></i></a>
